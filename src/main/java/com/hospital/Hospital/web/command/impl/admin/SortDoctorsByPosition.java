...
public class SortDoctorsByPosition extends Command {
    @Override
    public String execute(HttpServletRequest request, HttpServletResponse response, ActionType actionType) throws IOException, ServletException {
        ...
        List<Doctor> doctors = sublist(hospitalManagerDAO.getSortedDoctors(SQL_SORT_BY_POSITION), offset, offset+NUMBER_OF_RECORDS_PER_PAGE);
