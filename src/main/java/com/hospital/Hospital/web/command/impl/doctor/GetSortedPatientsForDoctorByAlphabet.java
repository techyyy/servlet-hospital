...
/**
 *
 * Get sorted patients for doctor by alphabet command
 *
 */
public class GetSortedPatientsForDoctorByAlphabet extends Command {

    private static final Logger LOG = Logger.getLogger(String.valueOf(GetSortedPatientsForDoctorByAlphabet.class));
