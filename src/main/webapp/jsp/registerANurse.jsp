...
<form action="controller" method="post">
    <input type="hidden" name="command" value="registerANurseSubmit">
    <section>
        <div class="container">
                ...
                <div class="col-12 col-md-8 col-lg-8 col-xl-6">
                    <div class="row">
                        <div class="col text-center">
                            <h1><fmt:message key="label.new_nurse"/></h1>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center mt-4">
                        <div class="col">
                            <input type="password" name="Password" class="form-control" placeholder=" <fmt:message key="placeholder.password"/>" required="required">
                        </div>
                    </div>
                    <div class="row align-items-center mt-4">
                        <div class="col">
