...
<form action="controller" method="post">
    <input type="hidden" name="command" value="registerAPatientSubmit">
    <section>
        <div class="container">
                ...
                <div class="col-12 col-md-8 col-lg-8 col-xl-6">
                    <div class="row">
                        <div class="col text-center">
                            <h1><fmt:message key="label.new_patient"/></h1>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center mt-4">
                        <div class="col">
                            <input type="date" name="BirthDate" class="form-control" placeholder=" <fmt:message key="label.birth_date"/>" required="required">
                        </div>
                    </div>
